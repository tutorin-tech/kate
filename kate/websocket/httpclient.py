...
from kate.websocket.escape import utf8, native_str
from kate.websocket import gen, httputil
...
class AsyncHTTPClient(Configurable):
    ...
    def configurable_default(cls) -> Type[Configurable]:
        from kate.websocket.simple_httpclient import SimpleAsyncHTTPClient
...
def main() -> None:
    from kate.websocket.options import define, options, parse_command_line
