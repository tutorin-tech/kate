...
from kate.websocket.util import Configurable, TimeoutError, import_object
...
class IOLoop(Configurable):
    ...
    .. testcode::
        ...
        import tornado
        from kate.websocket.iostream import IOStream
    ...
    def configure(
        ...
        from kate.websocket.platform.asyncio import BaseAsyncIOLoop
    ...
    def current(instance: bool = True) -> Optional["IOLoop"]:  # noqa: F811
        ...
        try:
            ...
            if instance:
                from kate.websocket.platform.asyncio import AsyncIOMainLoop
    ...
    def configurable_default(cls) -> Type[Configurable]:
        from kate.websocket.platform.asyncio import AsyncIOLoop
        ...
        *args: Any,
        ...
        if executor is None:
            if not hasattr(self, "_executor"):
                from kate.websocket.process import cpu_count
