...
from kate.websocket.escape import _unicode, native_str
from kate.websocket.log import define_logging_options
from kate.websocket.util import basestring_type, exec_in
