"""The module contains mixin with methods related to the cursor position."""

from kate.base import BaseTerminal


class CursorMixin(BaseTerminal):
    """The mixin contains methods related to the cursor position.
